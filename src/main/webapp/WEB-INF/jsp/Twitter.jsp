...
<head>
    ...
    <title>Employee365 Twitter page</title>
    <!-- Bootstrap core CSS -->
...
<div class="album text-muted">
    <div class="container">
        ...
        <form class="form-signin" action="postTweet" method="POST" >
            <h2 class="form-signin-heading">Tweet on Employee365 official twitter account</h2>
            <label for="tweet" class="sr-only">Create a sensation with your tweet</label>
            <textarea  id="tweet" class="form-control"  name="tweetInput"  rows="4" cols="50" required autofocus>
            </textarea>
