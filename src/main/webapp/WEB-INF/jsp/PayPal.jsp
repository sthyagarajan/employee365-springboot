...
<section class="jumbotron text-center">
    ...
    <h1 class="jumbotron-heading">Help our friends in Los Angeles</h1>
    <img src="http://cdn.cnn.com/cnnnext/dam/assets/171206124100-02-ca-wildfire-405-exlarge-169.jpg" class="img-fluid" alt="Responsive image">
...
<div class="album text-muted">
    <div class="container text-center">
        ...
        <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top" class="form-signin">
            ...
            <input type="hidden" name="hosted_button_id" value="T6AKGJJNJACKS">
